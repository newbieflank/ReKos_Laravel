...
<body class="bg-light">
    ...
    <div class="container bg-white my-4 p-3 p-md-4 shadow-sm rounded">
        ...
        @php
            ...
            $fotoLainnyaKost = !empty($otherKost[2]) ? asset($otherKost[2]) : null;
            ...
            $fotoLainnyaKamar = !empty($otherKamar[2]) ? asset($otherKamar[2]) : null;
        @endphp
        ...
        <div class="row g-2 mb-4 mb-md-5 gallery-wrapper position-relative">
            <div class="col-12 col-md-8 h-100">
                ...
                @else
                    <div class="w-100 h-100 bg-light rounded d-flex flex-column align-items-center justify-content-center text-muted border">
            ...
            <div class="col-12 col-md-4 d-none d-md-flex flex-column gap-2 h-100">
                ...
                <div class="position-relative w-100 rounded" style="height: calc(50% - 4px);">
                    @if($fotoTampakDepan)
                        <img src="{{ $fotoTampakDepan }}" class="w-100 h-100 object-fit-cover rounded" alt="Foto Tampak Depan">
                    @else
                        <div class="w-100 h-100 bg-light rounded d-flex flex-column align-items-center justify-content-center text-muted border">
                    ...
                    @endif
                    <div class="position-absolute w-100 h-100 top-0 start-0 bg-dark bg-opacity-25 rounded d-flex align-items-end justify-content-end p-3" data-bs-toggle="modal" data-bs-target="#galleryModal" style="cursor: pointer; transition: 0.3s;" onmouseover="this.classList.add('bg-opacity-50')" onmouseout="this.classList.remove('bg-opacity-50')">
                        <button class="btn btn-light fw-bold shadow-sm px-3 py-2"><i class="fa-solid fa-images me-2"></i> Lihat Semua Foto</button>
                    </div>
                </div>
            </div>
            <!-- Mobile overlay button -->
            <div class="col-12 d-md-none position-absolute bottom-0 end-0 p-3 d-flex justify-content-end" style="z-index: 10;">
                <button class="btn btn-light fw-bold shadow-sm px-3 py-2" data-bs-toggle="modal" data-bs-target="#galleryModal"><i class="fa-solid fa-images me-2"></i> Lihat Semua</button>
            </div>
        </div>
        ...
        <div id="info-umum" class="row border-bottom pb-4 mb-4 scroll-section">
            <div class="col-12 col-md-7">
                ...
                <h5 class="text-muted fw-semibold mb-2"><i class="fa-solid fa-house-chimney text-secondary me-2"></i>{{ $kos->boarding_house_name }}</h5>
      ...
      <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
          ...
          <div class="modal-body p-4 p-md-5">
            ...
            <div class="mb-5">
                <h5 class="fw-bold mb-3 heading-text"><i class="fa-solid fa-building text-primary me-2"></i> Foto Bangunan</h5>
                <div class="row g-3">
                    @if($fotoBangunan)
                    <div class="col-12 col-md-6">
                        <img src="{{ $fotoBangunan }}" class="w-100 rounded object-fit-cover shadow-sm" style="height: 300px;" alt="Foto Bangunan">
                    </div>
                    @endif
                    @if($fotoTampakDepan)
                    <div class="col-12 col-md-6">
                        <img src="{{ $fotoTampakDepan }}" class="w-100 rounded object-fit-cover shadow-sm" style="height: 300px;" alt="Foto Tampak Depan">
                    </div>
                    @endif
            ...
            <div class="mb-5">
                <h5 class="fw-bold mb-3 heading-text"><i class="fa-solid fa-bed text-primary me-2"></i> Foto Kamar</h5>
                <div class="row g-3">
                    @if($fotoKamar)
                    <div class="col-12 col-md-6">
                        <img src="{{ $fotoKamar }}" class="w-100 rounded object-fit-cover shadow-sm" style="height: 300px;" alt="Foto Kamar">
                    </div>
                    @else
            ...
            <div class="mb-5">
                <h5 class="fw-bold mb-3 heading-text"><i class="fa-solid fa-bath text-primary me-2"></i> Foto Kamar Mandi</h5>
                <div class="row g-3">
                    @if($fotoKamarMandi)
                    <div class="col-12 col-md-6">
                        <img src="{{ $fotoKamarMandi }}" class="w-100 rounded object-fit-cover shadow-sm" style="height: 300px;" alt="Foto Kamar Mandi">
                    </div>
                    @else
            ...
            <div class="mb-5">
                <h5 class="fw-bold mb-3 heading-text"><i class="fa-solid fa-couch text-primary me-2"></i> Foto Fasilitas Umum</h5>
                <div class="row g-3">
                    @if($fotoFasilitasKost)
                    <div class="col-12 col-md-6">
                        <div class="position-relative h-100">
                            <img src="{{ $fotoFasilitasKost }}" class="w-100 rounded object-fit-cover shadow-sm" style="height: 300px;" alt="Fasilitas Kost">
                            <span class="position-absolute bottom-0 start-0 m-2 badge bg-dark bg-opacity-75">Fasilitas Kost</span>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="col-12 col-md-6">
                        <div class="position-relative h-100">
                            <img src="{{ $fotoFasilitasKamar }}" class="w-100 rounded object-fit-cover shadow-sm" style="height: 300px;" alt="Fasilitas Kamar">
                            <span class="position-absolute bottom-0 start-0 m-2 badge bg-dark bg-opacity-75">Fasilitas Dalam Kamar</span>
                        </div>
                    </div>
                    @endif
            ...
            <div class="mb-3">
                <h5 class="fw-bold mb-3 heading-text"><i class="fa-solid fa-images text-primary me-2"></i> Foto Lainnya</h5>
                <div class="row g-3">
                    @if($fotoLainnyaKost)
                    <div class="col-12 col-md-6">
                        <div class="position-relative h-100">
                            <img src="{{ $fotoLainnyaKost }}" class="w-100 rounded object-fit-cover shadow-sm" style="height: 300px;" alt="Lainnya Kost">
                            <span class="position-absolute bottom-0 start-0 m-2 badge bg-dark bg-opacity-75">Kost</span>
                        </div>
                    </div>
                    @endif
                    @if($fotoLainnyaKamar)
                    <div class="col-12 col-md-6">
                        <div class="position-relative h-100">
                            <img src="{{ $fotoLainnyaKamar }}" class="w-100 rounded object-fit-cover shadow-sm" style="height: 300px;" alt="Lainnya Kamar">
                            <span class="position-absolute bottom-0 start-0 m-2 badge bg-dark bg-opacity-75">Kamar</span>
                        </div>
                    </div>
                    @endif
