                            ...
                            <label class="upload-box upload-small w-100 position-relative" style="min-height: 200px; cursor: pointer;">
                                ...
                                <div id="preview-3" class="d-flex flex-column align-items-center justify-content-center w-100 h-100 p-3 text-center">
                                    @if($img3)
                                        ...
                                        @if($preview3)
                                            <img src="{{ asset($preview3) }}" class="w-100 h-100 object-fit-cover rounded" alt="Foto Fasilitas">
                                        @else
        ...
        <script>
            ...
            function removeSingleImg(btn, previewId) {
                ...
                if(previewId === 'preview-1') {
                    defaultHtml = '<div class="bg-white shadow-sm p-3 rounded-circle mb-3 text-primary"><i class="fa-solid fa-cloud-arrow-up fs-4"></i></div><h6 class="fw-bold text-dark mb-1">Foto Utama Kamar</h6><p class="small text-muted mb-0">Klik untuk mengganti</p>';
                    ...
                    defaultHtml = '<i class="fa-solid fa-bath mb-2 fs-3 text-secondary"></i><h6 class="fw-bold text-dark mb-1">Foto Kamar Mandi</h6><p class="small text-muted mb-0">Klik untuk menambahkan</p>';
                    ...
                    defaultHtml = '<i class="fa-solid fa-couch mb-2 fs-3 text-secondary"></i><h6 class="fw-bold text-dark mb-1">Foto Fasilitas</h6><p class="small text-muted mb-0">Klik untuk menambahkan</p>';
            ...
            function renderMiniPreviews(previewId, inputId) {
                ...
                if(dt.files.length === 0) {
                    ...
                    if(previewId === 'preview-3') {
                        defHtml = '<i class="fa-solid fa-couch mb-2 fs-3 text-secondary"></i><h6 class="fw-bold text-dark mb-1">Foto Fasilitas</h6><p class="small text-muted mb-0">Klik untuk menambahkan</p>';
                        if(!document.getElementById('remove_other_image_2')) {
