        ...
        <script>
            ...
            function removeSingleImg(btn, previewId) {
                ...
                if(previewId === 'preview-1') {
                    defaultHtml = '<div class="bg-white shadow-sm p-3 rounded-circle mb-3 text-primary"><i class="fa-solid fa-cloud-arrow-up fs-4"></i></div><h6 class="fw-bold text-dark mb-1">Foto Utama Kost</h6><p class="small text-muted mb-0">Wajib diisi</p>';
                } else if(previewId === 'preview-2') {
                    defaultHtml = '<i class="fa-solid fa-building mb-2 fs-3 text-secondary"></i><h6 class="fw-bold text-dark mb-1">Foto Tampak Depan</h6><p class="small text-muted mb-0">Opsional</p>';
                }
            ...
            function renderMiniPreviews(previewId, inputId) {
                ...
                if (dt.files.length === 0) {
                    ...
                    if(previewId === 'preview-3') {
                        defHtml = '<i class="fa-solid fa-couch mb-2 fs-3 text-secondary"></i><h6 class="fw-bold text-dark mb-1">Foto Fasilitas Bersama</h6><p class="small text-muted mb-0">Opsional</p>';
